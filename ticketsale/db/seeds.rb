...
events = Event.create([{ name: 'Bon jovi', description: 'concierto', start_date: DateTime.new(2020,9,1,19), venue: venues[0] }, { name: 'Lady Gaga', description: 'beneficencia', start_date: DateTime.new(2021,9,1,19), venue: venues[0] }, { name: 'Los Pulentos', description: 'show', start_date: DateTime.new(2022,9,1,17), venue: venues[0] }])

d = Event.create(name: 'Bon jovi', description: 'concierto', start_date: DateTime.new(2020,9,1,19), venue: venues[0])
e = Event.create(name: 'Lady Gaga', description: 'beneficencia', start_date: DateTime.new(2021,9,1,19), venue: venues[0])
f = Event.create(name: 'Los Pulentos', description: 'show', start_date: DateTime.new(2022,9,1,17), venue: venues[0])
